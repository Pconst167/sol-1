...
void list_dirs();
__uint16_t create_file(char *filename, __uint16_t parent_dir_id, unsigned char *data, __uint16_t size, unsigned char permissions);
...
unsigned char disk_image[BOOT_SECT_SIZE * 512 + FS_TOTAL_SECTORS * 512];
...
void main(void){ 
  ...
  bin_id = create_dir("bin", usr_id);
  bin2_id = create_dir("bin2", usr_id);
  ...
  kernel_lba = create_file("kernel.0.1", boot_id, temp_buffer, file_size, 0x07);

  file_size = loadfile("../software/obj/install_kernel.obj", temp_buffer);
  create_file("install_kernel", boot_id, temp_buffer, file_size, 0x07);

  file_size = loadfile("etc/shell.cfg", temp_buffer);
  create_file("shell.cfg", etc_id, temp_buffer, file_size, 0x03);

  file_size = loadfile("usr/bin/shell.obj", temp_buffer);
  create_file("shell", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/ls.obj", temp_buffer);
  create_file("ls", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/mv.obj", temp_buffer);
  create_file("mv", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/ps.obj", temp_buffer);
  create_file("ps", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/mkbin.obj", temp_buffer);
  create_file("mkbin", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/reboot.obj", temp_buffer);
  create_file("reboot", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/rm.obj", temp_buffer);
  create_file("rm", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/cat.obj", temp_buffer);
  create_file("cat", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/date.obj", temp_buffer);
  create_file("date", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/mkdir.obj", temp_buffer);
  create_file("mkdir", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/rmdir.obj", temp_buffer);
  create_file("rmdir", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/echo.obj", temp_buffer);
  create_file("echo", bin_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/wc.obj", temp_buffer);
  create_file("wc", bin2_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/clear.obj", temp_buffer);
  create_file("clear", bin2_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/chmod.obj", temp_buffer);
  create_file("chmod", bin2_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/pwd.obj", temp_buffer);
  create_file("pwd", bin2_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/xxd.obj", temp_buffer);
  create_file("xxd", bin2_id, temp_buffer, file_size, 0x07);
  file_size = loadfile("../software/obj/ed.obj", temp_buffer);
  create_file("ed", bin2_id, temp_buffer, file_size, 0x07);
...
__uint16_t create_dir(char *dirname, __uint16_t parent_id){
  ...
  char day = local_time->tm_mday; 
  char month = local_time->tm_mon + 1;
  char year = local_time->tm_year + 1900 - 2000;
  char dh, dl, mh, ml, yh, yl;
  dl = day % 10;
  dh = day / 10; 
  ml = month % 10;
  mh = month / 10; 
  ...
  for(i = 0; i < 16 * 32 ; i += 32){
    if(*(disk_image + dir_id * 512 + 512 + i) != '\0')
      printf(
        ...
        *(unsigned char *)(disk_image + dir_id * 512 + 512 + i + 24), 
