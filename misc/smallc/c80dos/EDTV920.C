...
/* START OF SOURCE TO EDITOR.C FOR TELEVIDEO 920-LIKE TERMINALS */
...
#asm
HEADER:
        DB      'PUBLIC DOMAIN CP/M SMALL-C EDITOR VERSION 2.0.',0
#endasm
...
DISKIF1:
	RET
HEADER3:
	DB	'SMALL-C LIBRARY END',0
#endasm
/* END OF SMALL-C LIBRARY */
/* end #include smallc.lib */ /* -------------------------------*/
...
#define CONFIG "Configured for Televideo 920-like terminals, using...."
#define CONFIG1 "   ESC = y+32 x+32 cursor positioning,"
#define CONFIG2 "   CTRL-Z home-clear screen,"
#define CONFIG3 "   ESC-T delete to end of line,"
#define CONFIG4 "   CTRL-J scroll the screen up at the bottom line, and"
#define CONFIG5 "   ESC-E hardware scroll the screen down at the top line."
...
int mode ;
	...
	message("This version (2.0) by R. D. Keys.") ;
	message("") ;
	...
	message("") ;
	message("") ;
	message("Type: 'help' or '?' in the COMMAND mode, and") ;
	message("      'h' or '?' in the EDIT mode for on-line help screens."
	) ;
	message("") ;
	message("") ;
	outxy(0,1) ;
...
"Type help or ? when in COMMAND mode for a list of COMMAND mode commands."
); message(
"---------------------------------------------------------------------------"
); message(
...
"G <n> - go to line <n>                     H or ? - display help screen"
); message(
"I or ^I - enter insert mode                K <let> - delete to letter <let>"
); message(
"S <let> - set cursor to letter <let>"
); message(
"---------------------------------------------------------------------------"
); message(
...
"Type h or ? when in EDIT mode for more help."
); message(
"---------------------------------------------------------------------------"
); message(
