...
/* ED.C  -- Full screen editor for SMALL-C. */

/* TELEVIDEO 920 VERSION (RDK) */

/* ED1.C -- MODULE NUMBER ONE OF FIVE MODULES */
...
/* GLOBALS TO BE USED THROUGHOUT (RDK) */
 ...
 * (SO I LEFT IT IN THE BUFFER MODULE--- HI.  RDK.)
...
int mode ;
        ...
        outclr() ;
        outxy(0,SCRNL1) ;
        message("C EDITOR from Dr. Dobbs Journal, Jan 82.") ;
        message("Original program written by Edward K. Ream.") ;
        message("This version (3.00) by R. D. Keys.") ;
        message("") ;
...
/* commented out for all-in-one source (RDK) */
/*
#include ed2.c
#include ed3.c
#include ed4.c
...
/* ED2.C -- MODULE NUMBER TWO OF FIVE MODULES */
...
/* ED3.C -- MODULE NUMBER THREE OF FIVE MODULES */
...
/* ED4.C -- MODULE NUMBER FOUR OF FIVE MODULES */


/*
 * screen editor: terminal output module.
 * version: TELEVIDEO 920 TYPE TERMINAL (RDK)
 */
...
int k;
        ...
        syscout(27);
        syscout('E');
        /* delay for a while to insert new line (RDK) */
        k=0;
        while (k<4000) {
                ++k;
        }
...
/* ED5.C -- MODULE NUMBER FIVE OF FIVE MODULES */


/* EDITOR LIBRARY START */
/* NOTE - THIS IS NOT THE FULL SMALL-C LIBRARY */
#asm
HEADER2:
        DB      'START-LIBRARY',0
CCGO:
 ...
 * buffer must be dclared after all other variables
 * of the entire program.
 * NOTE: >>>>> DO NOT MOVE THIS DECLARATION <<<<<
 * NOTE: >>>>> THIS SHOULD NOT BE DECLARED EXTERNAL <<<<<
 * Note: buffer must have non-zero dimension.
 */
