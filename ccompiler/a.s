; --- FILENAME: ../solarium/src/usr/bin/shell.c
...
;; p = &format; 
  ...
  pop d
  mov [d], b
;; print("format, &format: "); printx16(format); printx16(&format); 
  mov b, __s11 ; "format, &format: "
  swp b
  push b
  call print
  add sp, 2
;; printx16(format); printx16(&format); 
  mov b, [bp + 5] ; $format             
  swp b
  push b
  call printx16
...
;; print("Error: Unknown argument type.\n"); 
  mov b, __s13 ; "Error: Unknown argument type.\n"
  swp b
  push b
  call print
  add sp, 2
...
__s11: .db "format, &format: ", 0
__s12: .db "\n\n", 0
__s13: .db "Error: Unknown argument type.\n", 0
