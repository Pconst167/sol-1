...
;; print("format, &format: "); printx16(format); print(", "); printx16(&format); 
  mov b, __s1 ; "format, &format: "
  swp b
  push b
  call print
  add sp, 2
;; printx16(format); print(", "); printx16(&format); 
  mov b, [bp + 5] ; $format             
  swp b
  push b
  call printx16
  add sp, 2
;; print(", "); printx16(&format); 
  mov b, __s2 ; ", "
  swp b
  push b
  call print
