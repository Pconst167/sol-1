...
/* FMC Configuration ---------------------------------------------------------*/
  ...
  NORSRAMTimingStructure.FMC_AddressSetupTime = 16;
  NORSRAMTimingStructure.FMC_AddressHoldTime = 0;
  NORSRAMTimingStructure.FMC_DataSetupTime = 16;
  NORSRAMTimingStructure.FMC_BusTurnAroundDuration = 2;
...
*/ 
  ...
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource7, GPIO_AF_FMC);       // PD15 <-> FMC_D1
