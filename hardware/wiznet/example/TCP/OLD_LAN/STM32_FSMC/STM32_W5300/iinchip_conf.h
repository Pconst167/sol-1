 ...
 */
//#define __DEF_IINCHIP_MAP_BASE__ ((uint32_t)0x60000000)
#define __DEF_IINCHIP_MAP_BASE__ ((uint32_t)0)
   ...
   #define SOCKET_REG_BASE   __DEF_IINCHIP_MAP_BASE__ + 0x0200 /**< The base address of SOCKET_REG  0x0200   */
#else
   #define COMMON_REG_BASE     0                               
   #define SOCKET_REG_BASE     0x0200   //0x0200                       
#endif
