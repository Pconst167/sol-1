...
#ifndef WNET__WNET_CONFIG_H
#define WNET__WNET_CONFIG_H

// Defines to save space
#define CALL_PTR2ACC	1
#define CALL_MOD4G	1
#define HIGH_LOW	1
...
#define PATH_WNET_CONF	"/etc/wnet.conf"
...
#endif /* WNET__WNET_CONFIG_H */

/*
 * $PchId: wnet_config.h,v 1.6 1998/10/23 20:14:28 philip Exp $
 */
